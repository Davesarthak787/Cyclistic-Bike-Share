...
head(total_trips_v2[which(total_trips_v2$month == "Sep"), ])
```
...
total_trips_v2 %>%
  ...
  geom_col(position = "dodge")+ scale_y_continuous(name="Number of rides") +
...
3.August month overall should be used more for promotion in general as it observes the most use of the bikes.
